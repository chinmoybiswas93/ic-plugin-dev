...
$errors = get_transient('quick_qr_code_errors') ?: [];
$old = get_transient('quick_qr_code_old') ?: [];
if ($errors) {
    delete_transient('quick_qr_code_errors');
}
if ($old) {
    delete_transient('quick_qr_code_old');
}
?>
...
<form id="quick-qr-code-settings-form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <?php wp_nonce_field('quick_qr_code_nonce'); ?>
    <div class="form-group">
